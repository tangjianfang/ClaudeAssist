        ...
        items: [
          {
            ...
            Icon: Code,
            logo: '/ClaudeAssist/logos/claude.svg',
            labelZh: 'Claude Code',
            labelEn: 'Claude Code',
            children: [
          ...
          { id: 'gemini-cli', path: '/tools/gemini-cli', Icon: Sparkles, logo: '/ClaudeAssist/logos/googlegemini.svg', labelZh: 'Gemini CLI', labelEn: 'Gemini CLI' },
          { id: 'github-copilot-cli', path: '/tools/github-copilot-cli', Icon: Slash, logo: '/ClaudeAssist/logos/githubcopilot.svg', labelZh: 'GitHub Copilot CLI', labelEn: 'GitHub Copilot CLI' },
        ],
      },
    ],
  },
