        ...
        items: [
          {
            ...
            Icon: Code,
            logo: '/ClaudeAssist/logos/anthropic.svg',
            labelZh: 'Claude Code',
            labelEn: 'Claude Code',
            children: [
          ...
          { id: 'opencode', path: '/tools/opencode', Icon: Terminal, logo: '/ClaudeAssist/logos/google.svg', labelZh: 'OpenCode', labelEn: 'OpenCode' },
          { id: 'gemini-cli', path: '/tools/gemini-cli', Icon: Sparkles, logo: '/ClaudeAssist/logos/google.svg', labelZh: 'Gemini CLI', labelEn: 'Gemini CLI' },
          { id: 'github-copilot-cli', path: '/tools/github-copilot-cli', Icon: Slash, logo: '/ClaudeAssist/logos/github.svg', labelZh: 'GitHub Copilot CLI', labelEn: 'GitHub Copilot CLI' },
        ],
      },
    ],
  },
